...
.ver-card { border: 1px solid #e4e7ed; border-radius: 8px; padding: 14px 16px;
  &.current { border-color: rgba(197,48,48,0.5); background: #FFF5F5; }
}
