package com.company.flow.sys.base.job.controller;
...
public class JobController {
    ...
    /** 手动触发：模板创建人字段一致性巡检通知 */
    @PostMapping("/template-field-sync")
    public Result<Integer> templateFieldSync() {
        int n = jobService.syncTemplateFieldScan();
        return Result.success("一致性巡检完成，已通知 " + n + " 个任务创建人（模板创建人字段待同步）", n);
    }
